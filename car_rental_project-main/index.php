...
<head>
    ...
    <title>CAR RENTAL BY SID</title>
    <!-- Add meta tags here -->


    <!-- Example of adding favicon -->
    <link rel="icon" type="image/png" href="./images/car-rent.png">
        ...
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li> <button class="adminbtn"><a href="carrentalagencylogin.php">Car Agency Login</a></button></li>
                </ul>
            </div>
