    ...
    if($error === 0){
        ...
        if(in_array($img_ex_lc,$allowed_exs)){
            ...
            move_uploaded_file($tmp_name,$img_upload_path);
                ...
                $available="Y";
                $query="INSERT INTO cars(CAR_NAME,FUEL_TYPE,VEHICLENO,CAPACITY,PRICE,CAR_IMG,AVAILABLE) values('$carname','$ftype','$vehicleno',$capacity,$price,'$new_img_name','$available')";
